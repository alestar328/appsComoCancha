      ...
      <section id="contacto" className="section bg-chicha">
        <div className="container-custom">
          ...
          <div className="text-center mb-10">
            ...
            <a
              href={WA_URL}
              className="btn-whatsapp inline-flex items-center px-7 py-3 text-base mb-10"
              target="_blank"
            ...
            <div className="flex items-center gap-4 max-w-xl mx-auto mb-10">
              ...
              <span className="text-gray-600 text-sm font-display font-bold">O LLENA EL FORMULARIO</span>
              <div className="flex-1 h-px" style={{ background: '#2a2a2a' }} />
            </div>
          </div>
